...
public class SiteIndexingServiceImpl implements SiteIndexingService {
    ...
    public CommonResponse indexPageByPath(String url) throws Exception {
        ...
        try{
            ...
            InputLinksEntity inputLinks = new InputLinksEntity(site, url, "");
    ...
    private void indexSite(SiteEntity site) throws InterruptedException {
        ...
        RecursiveSiteParser loaderFork = new RecursiveSiteParser(new InputLinksEntity(site,site.getUrl()
    ...
    private Set<String> indexPage(InputLinksEntity inputLinks, boolean isSiteIndexing)
    ...
    private PageEntity getPageForIndexing(String pageLink,InputLinksEntity inputLinks, boolean unique) {
    ...
    private boolean isContinueJobAfterSetSiteStatus(InputLinksEntity inputLinks, String error) {
        try {
            if (error != null) {
    ...
    private class RecursiveSiteParser extends RecursiveAction {
        private InputLinksEntity inputLinks;
        private int level;

        public RecursiveSiteParser(InputLinksEntity inputLinks, int level) {
        ...
        protected void compute() {
            ...
            for (String subLink : subLinks) {
                RecursiveSiteParser task = new RecursiveSiteParser(
                        new InputLinksEntity(inputLinks.site(), subLink, inputLinks.mask()), level + 1);
                taskList.add(task);
            }
