...
import searchengine.dto.common.search.SearchData;
...
import searchengine.services.siteindexing.WebPageParser;
...
public class SearchServiceImpl implements SearchService{
    ...
    private Tuple2<Integer,List<SearchData>>  getSearchResult(Set<String> searchLemmas, SearchRequest request
        ...
        List<PageRankEntity> pagesWithRank = indexRepository
    ...
    private List<PageRankEntity> getPagesSubListByLimits(List<PageRankEntity> pagesWithRank, SearchRequest request) {
    ...
    private List<SearchData> createSearchDataList(List<PageRankEntity> pagesWithRank, List<LemmaEntity> lemmas) {
